...
<html>
  <head>
      ...
      <link rel='stylesheet' href='scratch_files/style.css'>
            ...
            <div class='clear-block'>
                ...
                <div>
                  <div id='logo-sitename'>
                    <div class='clear-block'>
                        ...
                        <a href='index.php' title='Home' id='logo'>
                          <img style='padding-left:150px;padding-right:0px;padding-top:100px' width='350px' src='./scratch_files/wncc_logo.png' alt='Home'>
                        </a>    
                    </div>
                  </div>
                </div>
              ...
              <div id='right-header'>
                <div id='block-block-3' class='block block-block'>
                  <div class='content'>
                    <a href='register.php' class='btn btn-default btn-info '><span class='glyphicon glyphicon-plus'></span> Register</a>  
                  </div>
                </div>
              </div>
            </div>
                              ...
                              <div class='panel-flexible-inside panels-flexible-1-inside'>
                                <div class='panels-flexible-row panels-flexible-row-1-row_2 panels-flexible-row-last clear-block'>
                                  <div class='inside panels-flexible-row-inside panels-flexible-row-1-row_2-inside panels-flexible-row-inside-last clear-block'>
                                    <div class='panels-flexible-region panels-flexible-region-1-row_2_1 panels-flexible-region-first '>
                                      <div class='inside panels-flexible-region-inside panels-flexible-region-1-row_2_1-inside panels-flexible-region-inside-first'>
